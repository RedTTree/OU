...
public class finishFragment extends Fragment{
	  ...
	  private View ff_View;
	  //列表
	  private RecyclerView recyclerView;
	  private LinearLayoutManager layoutManager;
	  private ff_RecyclerViewAdapter adapter;
	  //数据源
					...
					// TODO 自动生成的方法存根
					 if(e==null){
							...
							if(arg0.size()!=0){
							 ...
							 if(adapter==null){
								 adapter=new ff_RecyclerViewAdapter(List,getActivity());
								 recyclerView.setAdapter(adapter);
							 }
							 else{
	...
	private void initView() {
		// TODO 自动生成的方法存根
				recyclerView= (RecyclerView)ff_View.findViewById(R.id.ff_recyclerView);
				mProgressBar = (MyProgressBar) ff_View.findViewById(R.id.ff_progressbar);
				//拿到RecyclerView
